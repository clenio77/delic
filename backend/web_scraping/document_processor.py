# backend/web_scraping/document_processor.py
import PyPDF2
...
def extract_text_from_document(file_path: str) -> str:
    ...
    try:
        if file_path.lower().endswith(".pdf"):
            ...
            # You might need a third-party tool or library (like textract) for robust .doc support.
...
if __name__ == "__main__":
    ...
    # Por exemplo: backend/data/raw_licitacoes/exemplo_edital.pdf
